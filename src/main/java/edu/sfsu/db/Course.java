...
public class Course {
    ...
    final private static String[] BIOLOGY_CORE = { "BIOL 100", "BIOL 101", "BIOL 176", "BIOL 210",
            "CHEM 115" };

    final public static Object[] CORE = { "MATH 226", "MATH 227", "MATH 324", "MATH 325",
            "PHYS 220", "PHYS 222", "PHYS 230", "PHYS 232", BIOLOGY_CORE, "CSC 210", "CSC 220",
            "CSC 230", "CSC 256", "CSC 300GW", "CSC 340", "CSC 413", "CSC 415", "CSC 510",
            "CSC 600", "CSC 648" };
    ...
    final public static String[] ELECTIVES = { "CSC 520", "CSC 615", "CSC 620", "CSC 621",
            ...
            "CSC 650", "CSC 651", "CSC 656", "CSC 658", "CSC 665", "CSC 667", "CSC 668", "CSC 675",
            "CSC 690", "CSC 697", "CSC 699", "MATH 400",
            // Graduate courses
